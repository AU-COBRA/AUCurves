...
Instance spec_of_vesta_mul_bignum : spec_of "vesta_coord_mul" :=
  fun functions =>
...
Instance spec_of_vesta_add_bignum : spec_of "vesta_coord_add" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_vesta_sub_bignum : spec_of "vesta_coord_sub" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_vesta_square_bignum : spec_of "vesta_coord_square" :=
  fun functions =>
...
Instance spec_of_vesta_opp_bignum : spec_of "vesta_coord_opp" :=
  fun functions =>
    forall (wsx old_out : list word.rep)
           (px pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
