...
Section BLS24_509_CurveOps_Specs.
  ...
  (** ** Correctness lemmas.
      ...
      [bls24_509_store_zero_correct] is Qed from
  ...
  Proof.
    ...
    (* [bls24_509_store_zero] is
       [NistWnafWrappers.store_zero_from_word_func] at these instances
       (same three [from_word] calls with literals 0, 1, 0, same
       parameter names), so [Hsz] meets the table premise of
       [store_zero_from_word_ok] by conversion.  The limb count (8 x 64
       here) plays no role: the lemma quantifies over
