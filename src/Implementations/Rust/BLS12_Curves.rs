...
pub unsafe fn _br2_load(arg : *const usize) -> usize {
    *arg
}

pub unsafe fn _br2_store(addr : *mut usize, val : usize) -> () {
    *addr = val;
}

pub unsafe fn bls12_add(out0 : *const usize, in0 : *const usize, in1 : *const usize) -> () {
    let x6 : usize;
    let x0 : usize;
    let x13 : usize;
    let x1 : usize;
    ...
    let x58 : usize;
    let x59 : usize;
    x0 = _br2_load((in0 as *const u8).wrapping_add(0usize) as *const usize);
    x1 = _br2_load((in0 as *const u8).wrapping_add(8usize) as *const usize);
    x2 = _br2_load((in0 as *const u8).wrapping_add(16usize) as *const usize);
    x3 = _br2_load((in0 as *const u8).wrapping_add(24usize) as *const usize);
    x4 = _br2_load((in0 as *const u8).wrapping_add(32usize) as *const usize);
    x5 = _br2_load((in0 as *const u8).wrapping_add(40usize) as *const usize);
    /*skip*/
    x6 = _br2_load((in1 as *const u8).wrapping_add(0usize) as *const usize);
    x7 = _br2_load((in1 as *const u8).wrapping_add(8usize) as *const usize);
    x8 = _br2_load((in1 as *const u8).wrapping_add(16usize) as *const usize);
    x9 = _br2_load((in1 as *const u8).wrapping_add(24usize) as *const usize);
    x10 = _br2_load((in1 as *const u8).wrapping_add(32usize) as *const usize);
    x11 = _br2_load((in1 as *const u8).wrapping_add(40usize) as *const usize);
    /*skip*/
    /*skip*/
    ...
    x59 = x53;
    /*skip*/
    _br2_store((out0 as *const u8).wrapping_add(0usize) as *mut usize, x54);
    _br2_store((out0 as *const u8).wrapping_add(8usize) as *mut usize, x55);
    _br2_store((out0 as *const u8).wrapping_add(16usize) as *mut usize, x56);
    _br2_store((out0 as *const u8).wrapping_add(24usize) as *mut usize, x57);
    _br2_store((out0 as *const u8).wrapping_add(32usize) as *mut usize, x58);
    _br2_store((out0 as *const u8).wrapping_add(40usize) as *mut usize, x59);
    /*skip*/
    return;
  }

  pub unsafe fn bls12_sub(out0 : *const usize, in0 : *const usize, in1 : *const usize) -> () {
    let x6 : usize;
    let x7 : usize;
    let x0 : usize;
    let x8 : usize;
    ...
    x39 = x33;
    /*skip*/
    _br2_store((out0 as *const u8).wrapping_add(0usize) as *mut usize, x34);
    _br2_store((out0 as *const u8).wrapping_add(8usize) as *mut usize, x35);
    _br2_store((out0 as *const u8).wrapping_add(16usize) as *mut usize, x36);
    _br2_store((out0 as *const u8).wrapping_add(24usize) as *mut usize, x37);
    _br2_store((out0 as *const u8).wrapping_add(32usize) as *mut usize, x38);
    _br2_store((out0 as *const u8).wrapping_add(40usize) as *mut usize, x39);
    /*skip*/
    return;
  }

  pub unsafe fn bls12_mul(out0 : *const usize, in0 : *const usize, in1 : *const usize) -> () {
    let x1 : usize;
    let x2 : usize;
    let x3 : usize;
    let x4 : usize;
    ...
    let x853 : usize;
      ...
      x853 = x847;
      /*skip*/
      _br2_store((out0 as *const u8).wrapping_add(0usize) as *mut usize, x848);
      _br2_store((out0 as *const u8).wrapping_add(8usize) as *mut usize, x849);
      _br2_store((out0 as *const u8).wrapping_add(16usize) as *mut usize, x850);
      _br2_store((out0 as *const u8).wrapping_add(24usize) as *mut usize, x851);
      _br2_store((out0 as *const u8).wrapping_add(32usize) as *mut usize, x852);
      _br2_store((out0 as *const u8).wrapping_add(40usize) as *mut usize, x853);
      /*skip*/
      return;
    }

    pub unsafe fn bls12_square(out0 : *const usize, in0 : *const usize) -> () {
        let x11 : usize;
        let x20 : usize;
        let x23 : usize;
        let x25 : usize;
      ...
      x847 = x841;
      /*skip*/
      _br2_store((out0 as *const u8).wrapping_add(0usize) as *mut usize, x842);
      _br2_store((out0 as *const u8).wrapping_add(8usize) as *mut usize, x843);
      _br2_store((out0 as *const u8).wrapping_add(16usize) as *mut usize, x844);
      _br2_store((out0 as *const u8).wrapping_add(24usize) as *mut usize, x845);
      _br2_store((out0 as *const u8).wrapping_add(32usize) as *mut usize, x846);
      _br2_store((out0 as *const u8).wrapping_add(40usize) as *mut usize, x847);
      /*skip*/
      return;
    }

pub unsafe fn bls12_opp(out0 : *const usize, in0 : *const usize) -> () {
  let x0 : usize;
  let x1 : usize;
  let x2 : usize;
  let x7 : usize;
  ...
  x33 = x27;
  /*skip*/
  _br2_store((out0 as *const u8).wrapping_add(0usize) as *mut usize, x28);
  _br2_store((out0 as *const u8).wrapping_add(8usize) as *mut usize, x29);
  _br2_store((out0 as *const u8).wrapping_add(16usize) as *mut usize, x30);
  _br2_store((out0 as *const u8).wrapping_add(24usize) as *mut usize, x31);
  _br2_store((out0 as *const u8).wrapping_add(32usize) as *mut usize, x32);
  _br2_store((out0 as *const u8).wrapping_add(40usize) as *mut usize, x33);
  /*skip*/
  return;
}

pub unsafe fn bls12_to_montgomery(out0 : *const usize, in0 : *const usize) -> () {
    let x1 : usize;
    let x2 : usize;
    let x3 : usize;
    let x4 : usize;
  ...
  x415 = x409;
  /*skip*/
  _br2_store((out0 as *const u8).wrapping_add(0usize) as *mut usize, x410);
  _br2_store((out0 as *const u8).wrapping_add(8usize) as *mut usize, x411);
  _br2_store((out0 as *const u8).wrapping_add(16usize) as *mut usize, x412);
  _br2_store((out0 as *const u8).wrapping_add(24usize) as *mut usize, x413);
  _br2_store((out0 as *const u8).wrapping_add(32usize) as *mut usize, x414);
  _br2_store((out0 as *const u8).wrapping_add(40usize) as *mut usize, x415);
  /*skip*/
  return;
}

pub unsafe fn bls12_from_montgomery(out0 : *const usize, in0 : *const usize) -> () {
    let x0 : usize;
    let x17 : usize;
    let x19 : usize;
    let x16 : usize;
    ...
    x257 = x251;
    /*skip*/
    _br2_store((out0 as *const u8).wrapping_add(0usize) as *mut usize, x252);
    _br2_store((out0 as *const u8).wrapping_add(8usize) as *mut usize, x253);
    _br2_store((out0 as *const u8).wrapping_add(16usize) as *mut usize, x254);
    _br2_store((out0 as *const u8).wrapping_add(24usize) as *mut usize, x255);
    _br2_store((out0 as *const u8).wrapping_add(32usize) as *mut usize, x256);
    _br2_store((out0 as *const u8).wrapping_add(40usize) as *mut usize, x257);
    /*skip*/
    return;
  }

pub unsafe fn Fp2_mul(outr : *const usize, outi : *const usize, xr : *const usize, xi : *const usize, yr : *const usize, yi : *const usize) -> () {
    let v0 : usize;
    let v0_arr = [0usize; 6usize];
    let v0 = v0_arr.as_ptr();
    let v1_arr = [0usize; 6usize];
    let v1 = v1_arr.as_ptr();
    let v2_arr = [0usize; 6usize];
    let v2 = v2_arr.as_ptr();
    bls12_mul(v0, xr, yr);
    bls12_mul(v1, xi, yi);
...
pub unsafe fn Fp2_add(outr : *const usize, outi : *const usize, xr : *const usize, xi : *const usize, yr : *const usize, yi : *const usize) -> () {
    bls12_add(outr, yr, xr);
    bls12_add(outi, yi, xi);
    return;
}

pub unsafe fn Fp2_square(outr : *const usize, outi : *const usize, inr : *const usize, ini : *const usize) -> () {
    let v : usize;
    let v_arr = [0usize; 6usize];
    let v = v_arr.as_ptr();
    bls12_add(v, inr, ini);
...
pub unsafe fn Fp2_sub(outr : *const usize, outi : *const usize, xr : *const usize, xi : *const usize, yr : *const usize, yi : *const usize) -> () {
  bls12_sub(outr, xr, yr);
  bls12_sub(outi, xi, yi);
  return;
}

pub unsafe fn felem_copy_64(out : *const usize, elem : *const usize) -> () {
    _br2_store((out as *const u8).wrapping_add(0usize) as *mut usize, _br2_load((elem as *const u8).wrapping_add(0usize) as *const usize));
    _br2_store((out as *const u8).wrapping_add(8usize) as *mut usize, _br2_load((elem as *const u8).wrapping_add(8usize) as *const usize));
    _br2_store((out as *const u8).wrapping_add(16usize) as *mut usize, _br2_load((elem as *const u8).wrapping_add(16usize) as *const usize));
    _br2_store((out as *const u8).wrapping_add(24usize) as *mut usize, _br2_load((elem as *const u8).wrapping_add(24usize) as *const usize));
    _br2_store((out as *const u8).wrapping_add(32usize) as *mut usize, _br2_load((elem as *const u8).wrapping_add(32usize) as *const usize));
    _br2_store((out as *const u8).wrapping_add(40usize) as *mut usize, _br2_load((elem as *const u8).wrapping_add(40usize) as *const usize));
    /*skip*/
    return;
  }

pub unsafe fn Fp2_add_alt2(outr : *const usize, outi : *const usize, xr : *const usize, xi : *const usize, yr : *const usize, yi : *const usize) -> () {
  let xrsep : usize;
  let xrsep_arr = [0usize; 6usize];
  let xrsep = xrsep_arr.as_ptr();
  let xisep_arr = [0usize; 6usize];
  let xisep = xisep_arr.as_ptr();
  let yrsep_arr = [0usize; 6usize];
  let yrsep = yrsep_arr.as_ptr();
  let yisep_arr = [0usize; 6usize];
  let yisep = yisep_arr.as_ptr();
  felem_copy_64(xrsep, xr);
  felem_copy_64(yrsep, yr);
  felem_copy_64(xisep, xi);
  felem_copy_64(yisep, yi);
  Fp2_add(outr, outi, xrsep, xisep, yrsep, yisep);
  return;
}

pub unsafe fn Fp2_sub_alt2(outr : *const usize, outi : *const usize, xr : *const usize, xi : *const usize, yr : *const usize, yi : *const usize) -> () {
    let xrsep : usize;
    let xrsep_arr = [0usize; 6usize];
    let xrsep = xrsep_arr.as_ptr();
    let xisep_arr = [0usize; 6usize];
...
pub unsafe fn Fp2_mul_alt2(outr : *const usize, outi : *const usize, xr : *const usize, xi : *const usize, yr : *const usize, yi : *const usize) -> () {
  let xrsep : usize;
  let xrsep_arr = [0usize; 6usize];
  let xrsep = xrsep_arr.as_ptr();
  let xisep_arr = [0usize; 6usize];
...
pub unsafe fn Fp2_square_alt2(outr : *const usize, outi : *const usize, xr : *const usize, xi : *const usize) -> () {
  let xrsep : usize;
  let xrsep_arr = [0usize; 6usize];
  let xrsep = xrsep_arr.as_ptr();
  let xisep_arr = [0usize; 6usize];
...
pub unsafe fn BLS12_add(outx : *const usize, outy : *const usize, outz : *const usize, X1 : *const usize, Y1 : *const usize, Z1 : *const usize, X2 : *const usize, Y2 : *const usize, Z2 : *const usize) -> () {
  let three_b : usize;
  let three_b_arr = [0usize; 6usize];
  let three_b = three_b_arr.as_ptr();
  let t0_arr = [0usize; 6usize];
  let t0 = t0_arr.as_ptr();
  let t1_arr = [0usize; 6usize];
  let t1 = t1_arr.as_ptr();
  let t2_arr = [0usize; 6usize];
  let t2 = t2_arr.as_ptr();
  let t3_arr = [0usize; 6usize];
  let t3 = t3_arr.as_ptr();
  let t4_arr = [0usize; 6usize];
  let t4 = t4_arr.as_ptr();
  let t5_arr = [0usize; 6usize];
  let t5 = t5_arr.as_ptr();
  _br2_store(three_b as *mut usize, 4933130441833534766usize);
  _br2_store((three_b as *const u8).wrapping_add(8usize) as *mut usize, 15904462746612662304usize);
  _br2_store((three_b as *const u8).wrapping_add(16usize) as *mut usize, 8034115857496836953usize);
  _br2_store((three_b as *const u8).wrapping_add(24usize) as *mut usize, 12755092135412849606usize);
  _br2_store((three_b as *const u8).wrapping_add(32usize) as *mut usize, 7007796720291435703usize);
  _br2_store((three_b as *const u8).wrapping_add(40usize) as *mut usize, 252692002104915169usize);
  bls12_mul(t0, X1, X2);
  bls12_mul(t1, Y1, Y2);
  bls12_mul(t2, Z1, Z2);
  bls12_add(t3, X1, Y1);
...
pub unsafe fn BLS12_add_alt(outx : *const usize, outy : *const usize, outz : *const usize, X1 : *const usize, Y1 : *const usize, Z1 : *const usize, X2 : *const usize, Y2 : *const usize, Z2 : *const usize) -> () {
  let X1sep : usize;
  let X1sep_arr = [0usize; 6usize];
  let X1sep = X1sep_arr.as_ptr();
  let Y1sep_arr = [0usize; 6usize];
  let Y1sep = Y1sep_arr.as_ptr();
  let Z1sep_arr = [0usize; 6usize];
  let Z1sep = Z1sep_arr.as_ptr();
  let X2sep_arr = [0usize; 6usize];
  let X2sep = X2sep_arr.as_ptr();
  let Y2sep_arr = [0usize; 6usize];
  let Y2sep = Y2sep_arr.as_ptr();
  let Z2sep_arr = [0usize; 6usize];
  let Z2sep = Z2sep_arr.as_ptr();
  felem_copy_64(X1sep, X1);
  felem_copy_64(Y1sep, Y1);
  felem_copy_64(Z1sep, Z1);
  felem_copy_64(X2sep, X2);
  felem_copy_64(Y2sep, Y2);
  felem_copy_64(Z2sep, Z2);
  BLS12_add(outx, outy, outz, X1sep, Y1sep, Z1sep, X2sep, Y2sep, Z2sep);
  return;
}

pub unsafe fn BLS12_G2_add(outxr : *const usize, outxi : *const usize, outyr : *const usize, outyi : *const usize, outzr : *const usize, outzi : *const usize, X1r : *const usize, X1i : *const usize, Y1r : *const usize, Y1i : *const usize, Z1r : *const usize, Z1i : *const usize, X2r : *const usize, X2i : *const usize, Y2r : *const usize, Y2i : *const usize, Z2r : *const usize, Z2i : *const usize) -> () {
  let three_br : usize;
  let three_br_arr = [0usize; 6usize];
  let three_br = three_br_arr.as_ptr();
  let t0r_arr = [0usize; 6usize];
  let t0r = t0r_arr.as_ptr();
  let t1r_arr = [0usize; 6usize];
  let t1r = t1r_arr.as_ptr();
  let t2r_arr = [0usize; 6usize];
  let t2r = t2r_arr.as_ptr();
  let t3r_arr = [0usize; 6usize];
  let t3r = t3r_arr.as_ptr();
  let t4r_arr = [0usize; 6usize];
  let t4r = t4r_arr.as_ptr();
  let t5r_arr = [0usize; 6usize];
  let t5r = t5r_arr.as_ptr();
  let three_bi_arr = [0usize; 6usize];
  let three_bi = three_bi_arr.as_ptr();
  let t0i_arr = [0usize; 6usize];
  let t0i = t0i_arr.as_ptr();
  let t1i_arr = [0usize; 6usize];
  let t1i = t1i_arr.as_ptr();
  let t2i_arr = [0usize; 6usize];
  let t2i = t2i_arr.as_ptr();
  let t3i_arr = [0usize; 6usize];
  let t3i = t3i_arr.as_ptr();
  let t4i_arr = [0usize; 6usize];
  let t4i = t4i_arr.as_ptr();
  let t5i_arr = [0usize; 6usize];
  let t5i = t5i_arr.as_ptr();
  _br2_store(three_br as *mut usize, 4933130441833534766usize);
  _br2_store((three_br as *const u8).wrapping_add(8usize) as *mut usize, 15904462746612662304usize);
  _br2_store((three_br as *const u8).wrapping_add(16usize) as *mut usize, 8034115857496836953usize);
  _br2_store((three_br as *const u8).wrapping_add(24usize) as *mut usize, 12755092135412849606usize);
  _br2_store((three_br as *const u8).wrapping_add(32usize) as *mut usize, 7007796720291435703usize);
  _br2_store((three_br as *const u8).wrapping_add(40usize) as *mut usize, 252692002104915169usize);
  _br2_store(three_bi as *mut usize, 4933130441833534766usize);
  _br2_store((three_bi as *const u8).wrapping_add(8usize) as *mut usize, 15904462746612662304usize);
  _br2_store((three_bi as *const u8).wrapping_add(16usize) as *mut usize, 8034115857496836953usize);
  _br2_store((three_bi as *const u8).wrapping_add(24usize) as *mut usize, 12755092135412849606usize);
  _br2_store((three_bi as *const u8).wrapping_add(32usize) as *mut usize, 7007796720291435703usize);
  _br2_store((three_bi as *const u8).wrapping_add(40usize) as *mut usize, 252692002104915169usize);
  Fp2_mul_alt2(t0r, t0i, X1r, X1i, X2r, X2i);
  Fp2_mul_alt2(t1r, t1i, Y1r, Y1i, Y2r, Y2i);
  Fp2_mul_alt2(t2r, t2i, Z1r, Z1i, Z2r, Z2i);
  Fp2_add_alt2(t3r, t3i, X1r, X1i, Y1r, Y1i);
  Fp2_add_alt2(t4r, t4i, X2r, X2i, Y2r, Y2i);
  Fp2_mul_alt2(t3r, t3i, t3r, t3i, t4r, t4i);
  Fp2_add_alt2(t4r, t4i, t0r, t0i, t1r, t1i);
  Fp2_sub_alt2(t3r, t3i, t3r, t3i, t4r, t4i);
  Fp2_add_alt2(t4r, t4i, X1r, X1i, Z1r, Z1i);
  Fp2_add_alt2(t5r, t5i, X2r, X2i, Z2r, Z2i);
  Fp2_mul_alt2(t4r, t4i, t4r, t4i, t5r, t5i);
  Fp2_add_alt2(t5r, t5i, t0r, t0i, t2r, t2i);
  Fp2_sub_alt2(t4r, t4i, t4r, t4i, t5r, t5i);
  Fp2_add_alt2(t5r, t5i, Y1r, Y1i, Z1r, Z1i);
  Fp2_add_alt2(outxr, outxi, Y2r, Y2i, Z2r, Z2i);
  Fp2_mul_alt2(t5r, t5i, t5r, t5i, outxr, outxi);
  Fp2_add_alt2(outxr, outxi, t1r, t1i, t2r, t2i);
  Fp2_sub_alt2(t5r, t5i, t5r, t5i, outxr, outxi);
  Fp2_mul_alt2(outzr, outzi, three_br, three_bi, t2r, t2i);
  Fp2_sub_alt2(outxr, outxi, t1r, t1i, outzr, outzi);
  Fp2_add_alt2(outzr, outzi, outzr, outzi, t1r, t1i);
  Fp2_mul_alt2(outyr, outyi, outxr, outxi, outzr, outzi);
  Fp2_add_alt2(t1r, t1i, t0r, t0i, t0r, t0i);
  Fp2_add_alt2(t1r, t1i, t1r, t1i, t0r, t0i);
  Fp2_mul_alt2(t4r, t4i, three_br, three_bi, t4r, t4i);
  Fp2_mul_alt2(t0r, t0i, t1r, t1i, t4r, t4i);
  Fp2_add_alt2(outyr, outyi, outyr, outyi, t0r, t0i);
  Fp2_mul_alt2(t0r, t0i, t5r, t5i, t4r, t4i);
  Fp2_mul_alt2(outxr, outxi, t3r, t3i, outxr, outxi);
  Fp2_sub_alt2(outxr, outxi, outxr, outxi, t0r, t0i);
  Fp2_mul_alt2(t0r, t0i, t3r, t3i, t1r, t1i);
  Fp2_mul_alt2(outzr, outzi, t5r, t5i, outzr, outzi);
  Fp2_add_alt2(outzr, outzi, outzr, outzi, t0r, t0i);
  return;
}

pub unsafe fn BLS12_G2_add_alt(outxr : *const usize, outxi : *const usize, outyr : *const usize, outyi : *const usize, outzr : *const usize, outzi : *const usize, X1r : *const usize, X1i : *const usize, Y1r : *const usize, Y1i : *const usize, Z1r : *const usize, Z1i : *const usize, X2r : *const usize, X2i : *const usize, Y2r : *const usize, Y2i : *const usize, Z2r : *const usize, Z2i : *const usize) -> () {
  let X1rsep : usize;
  let X1rsep_arr = [0usize; 6usize];
  let X1rsep = X1rsep_arr.as_ptr();
  let X1isep_arr = [0usize; 6usize];
  let X1isep = X1isep_arr.as_ptr();
  let Y1rsep_arr = [0usize; 6usize];
  let Y1rsep = Y1rsep_arr.as_ptr();
  let Y1isep_arr = [0usize; 6usize];
  let Y1isep = Y1isep_arr.as_ptr();
  let Z1rsep_arr = [0usize; 6usize];
  let Z1rsep = Z1rsep_arr.as_ptr();
  let Z1isep_arr = [0usize; 6usize];
  let Z1isep = Z1isep_arr.as_ptr();
  let X2rsep_arr = [0usize; 6usize];
  let X2rsep = X2rsep_arr.as_ptr();
  let X2isep_arr = [0usize; 6usize];
  let X2isep = X2isep_arr.as_ptr();
  let Y2rsep_arr = [0usize; 6usize];
  let Y2rsep = Y2rsep_arr.as_ptr();
  let Y2isep_arr = [0usize; 6usize];
  let Y2isep = Y2isep_arr.as_ptr();
  let Z2rsep_arr = [0usize; 6usize];
  let Z2rsep = Z2rsep_arr.as_ptr();
  let Z2isep_arr = [0usize; 6usize];
  let Z2isep = Z2isep_arr.as_ptr();
  felem_copy_64(X1rsep, X1r);
  felem_copy_64(X1isep, X1i);
  felem_copy_64(Y1rsep, Y1r);
  felem_copy_64(Y1isep, Y1i);
  felem_copy_64(Z1rsep, Z1r);
  felem_copy_64(Z1isep, Z1i);
  felem_copy_64(X2rsep, X2r);
  felem_copy_64(X2isep, X2i);
  felem_copy_64(Y2rsep, Y2r);
  felem_copy_64(Y2isep, Y2i);
  felem_copy_64(Z2rsep, Z2r);
  felem_copy_64(Z2isep, Z2i);
  BLS12_G2_add(outxr, outxi, outyr, outyi, outzr, outzi, X1rsep, X1isep, Y1rsep, Y1isep, Z1rsep, Z1isep, X2rsep, X2isep, Y2rsep, Y2isep, Z2rsep, Z2isep);
  return;
}

fn main() {
    let x1 : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
    let y1 : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
    let z1 : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let x2 : felem_as_words = [1000192263423663127, 10063423557586042878, 206342320401305268, 10009945728364010941, 8000774818643959860, 100021051382923523];
    let y2 : felem_as_words = [10001922859260663127, 10000707557586042878, 200084726342305268, 10009945728634230941, 8000634238643959860, 100634231382923523];
    let z2 : felem_as_words = [10001922859260663127, 10000707556342342878, 200084726342305268, 10009946342364010941, 8063423818643959860, 100021051382634233];
    let z2i : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
    let y2i : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
    let x2i : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let z1i : felem_as_words = [1000192263423663127, 10063423557586042878, 206342320401305268, 10009945728364010941, 8000774818643959860, 100021051382923523];
    let y1i : felem_as_words = [10001922859260663127, 10000707557586042878, 200084726342305268, 10009945728634230941, 8000634238643959860, 100634231382923523];
    let x1i : felem_as_words = [10001922859260663127, 10000707556342342878, 200084726342305268, 10009946342364010941, 8063423818643959860, 100021051382634233];
    let outx : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outy : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outz : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outxi : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outyi : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outzi : felem_as_words = [0, 0, 0, 0, 0, 0];
    let x1_ptr = x1.as_ptr();
    let y1_ptr = y1.as_ptr();
    let z1_ptr = z1.as_ptr();
    let x2_ptr = x2.as_ptr();
    let y2_ptr = y2.as_ptr();
    let z2_ptr = z2.as_ptr();
    let outx_ptr = outx.as_ptr();
    let outy_ptr = outy.as_ptr();
    let outz_ptr = outz.as_ptr();
    let x1i_ptr = x1i.as_ptr();
    let y1i_ptr = y1i.as_ptr();
    let z1i_ptr = z1i.as_ptr();
    let x2i_ptr = x2i.as_ptr();
    let y2i_ptr = y2i.as_ptr();
    let z2i_ptr = z2i.as_ptr();
    let outxi_ptr = outxi.as_ptr();
    let outyi_ptr = outyi.as_ptr();
    let outzi_ptr = outzi.as_ptr();
    unsafe { BLS12_G2_add_alt(outx_ptr, outxi_ptr, outy_ptr, outyi_ptr, outz_ptr, outzi_ptr, x1_ptr, x1i_ptr, y1_ptr, y1i_ptr, z1_ptr, z1i_ptr, x2_ptr, x2i_ptr, y2_ptr, y2i_ptr, z2_ptr, z2i_ptr) };
    println!("outx is {:?}", outx);
    println!("outy is {:?}", outy);
    println!("outz is {:?}", outz);
    println!("outxi is {:?}", outxi);
    println!("outyi is {:?}", outyi);
    println!("outzi is {:?}", outzi);
}

#[test]
fn test_addition() {
    let a : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
    let b : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ bls12_add(out.as_ptr(), a.as_ptr(), b.as_ptr()) };
...
fn test_sub() {
    ...
    let b : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ bls12_sub(out.as_ptr(), b.as_ptr(), a.as_ptr()) };
...
fn test_mul() {
    ...
    let b : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ bls12_mul(out.as_ptr(), b.as_ptr(), a.as_ptr()) };
...
fn test_square() {
    let b : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ bls12_square(out.as_ptr(), b.as_ptr()) };
...
fn test_opp() {
    let b : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ bls12_opp(out.as_ptr(), b.as_ptr()) };
...
fn test_to_montgomery() {
    let b : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ bls12_to_montgomery(out.as_ptr(), b.as_ptr()) };
...
fn test_from_montgomery() {
    let b : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ bls12_from_montgomery(out.as_ptr(), b.as_ptr()) };
...
fn test_Fp2_add() {
    ...
    let br : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
    let bi : felem_as_words = [10001922859260663127, 10000707557586042878, 200084720401305268, 10009945728364010941, 8000774818643959860, 100021051382923523];
    let outr : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outi : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ Fp2_add(outr.as_ptr(), outi.as_ptr(), ar.as_ptr(), ai.as_ptr(), br.as_ptr(), bi.as_ptr()) };
...
fn test_Fp2_mul() {
    ...
    let outr : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outi : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ Fp2_mul(outr.as_ptr(), outi.as_ptr(), ar.as_ptr(), ai.as_ptr(), br.as_ptr(), bi.as_ptr()) };
    assert_eq!(outr, [10459431016077863595, 264641511517208575, 7335574573564081700, 13031082034124264127, 7186103778470702294, 1823798617647539866]);
    assert_eq!(outi, [4296154566626538358, 7669025629547932200, 10010748057355742626, 6939193364983044192, 9764371106379672806, 360897097369517626]);
}
...
fn test_Fp2_sub() {
    ...
    let outr : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outi : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ Fp2_sub(outr.as_ptr(), outi.as_ptr(), ar.as_ptr(), ai.as_ptr(), br.as_ptr(), bi.as_ptr()) };
...
#[test]
fn test_felem_copy_64() {
    let a : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
    let out : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ felem_copy_64(out.as_ptr(), a.as_ptr()) };
    assert_eq!(out, [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093]);
}
...
fn test_Fp2_add_alt() {
    ...
    let outr : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outi : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ Fp2_add_alt2(outr.as_ptr(), outi.as_ptr(), ar.as_ptr(), ai.as_ptr(), br.as_ptr(), bi.as_ptr()) };
    assert_eq!(outr, [2225382075174660787, 18051049640511111161, 1285423602006526342, 9312752346981848241, 175385945800696072, 645705256914617617]);
    assert_eq!(outi, [1349382075174660787, 17310049640511111161, 1339623602006526342, 7222752346981848241, 5562385945800696072, 682505256914617617]);
}
...
fn test_Fp2_mul_alt() {
    ...
    let outr : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outi : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ Fp2_mul_alt2(outr.as_ptr(), outi.as_ptr(), ar.as_ptr(), ai.as_ptr(), br.as_ptr(), bi.as_ptr()) };
    assert_eq!(outr, [10459431016077863595, 264641511517208575, 7335574573564081700, 13031082034124264127, 7186103778470702294, 1823798617647539866]);
    assert_eq!(outi, [4296154566626538358, 7669025629547932200, 10010748057355742626, 6939193364983044192, 9764371106379672806, 360897097369517626]);
}

#[test]
fn test_Fp2_square_alt() {
    let ar : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
    let ai : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
    let outr : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outi : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ Fp2_square_alt2(outr.as_ptr(), outi.as_ptr(), ar.as_ptr(), ai.as_ptr()) };
    assert_eq!(outi, [9084902848110124148, 8330211261126802722, 17851081340430083445, 6317344973833155910, 16990412299079728733, 1451528035995569023]);
    assert_eq!(outr, [9250792947371081702, 13312402838753247253, 10869193620707279102, 11333961298938972590, 7684274900895356512, 1747260413168303358]);
}
...
fn test_Fp2_sub_alt() {
    ...
    let outr : felem_as_words = [0, 0, 0, 0, 0, 0];
    let outi : felem_as_words = [0, 0, 0, 0, 0, 0];
    unsafe{ Fp2_sub_alt2(outr.as_ptr(), outi.as_ptr(), ar.as_ptr(), ai.as_ptr(), br.as_ptr(), bi.as_ptr()) };
    assert_eq!(outr, [15775024504072437765, 14396378599048577019, 715654161203915805, 10706349037672929591, 1394580382222327966, 354463154148770570]);
    assert_eq!(outi, [18239024504072437765, 15755378599048577019, 939454161203915805, 5649604963963377975, 8007580382222327967, 482463154148770570]);
}


//All remaining tests: test vectors consist of random numbers. These are not points on the curve. We assert that output coincides with corresponding C function.
#[test]
fn test_BLS12_add() {
  let x1 : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
  let y1 : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
  ...
  let outy_ptr = outy.as_ptr();
  let outz_ptr = outz.as_ptr();
  unsafe { BLS12_add(outx_ptr, outy_ptr, outz_ptr, x1_ptr, y1_ptr, z1_ptr, x2_ptr, y2_ptr, z2_ptr) };
  assert_eq!(outx, [8042314163485666508, 7283425319937837477, 897497546009684113, 11283088606680975805, 6805631890676806037, 1094046399768147098]);
  assert_eq!(outy, [17006609985731387894, 7141319321119514449, 3710743313441996424, 18247003658694504149, 9610371327549030612, 434342132118940203]);
  assert_eq!(outz, [4864416833361600443, 723423890055292666, 12017688482299183080, 12645795770743256297, 11161989860390452311, 79502220975547348]);
}

#[test]
fn test_BLS12_add_alt() {
  let x1 : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
  let y1 : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
  let z1 : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
  let x2 : felem_as_words = [1000192263423663127, 10063423557586042878, 206342320401305268, 10009945728364010941, 8000774818643959860, 100021051382923523];
  ...
  let outy : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outz : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outxa : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outya : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outza : felem_as_words = [0, 0, 0, 0, 0, 0];
  let x1_ptr = x1.as_ptr();
  let y1_ptr = y1.as_ptr();
  let z1_ptr = z1.as_ptr();
  let x2_ptr = x2.as_ptr();
  ...
  let outy_ptr = outy.as_ptr();
  let outz_ptr = outz.as_ptr();
  let outxa_ptr = outxa.as_ptr();
  let outya_ptr = outya.as_ptr();
  let outza_ptr = outza.as_ptr();
  unsafe { BLS12_add(outx_ptr, outy_ptr, outz_ptr, x1_ptr, y1_ptr, z1_ptr, x2_ptr, y2_ptr, z2_ptr) };
  unsafe { BLS12_add_alt(outxa_ptr, outya_ptr, outza_ptr, x1_ptr, y1_ptr, z1_ptr, x2_ptr, y2_ptr, z2_ptr) };
  assert_eq!(outx, outxa);
  assert_eq!(outy, outya);
  assert_eq!(outz, outza);
}

#[test]
fn test_BLS12_G2_add() {
  let x1 : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
  let y1 : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
  let z1 : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
  let x2 : felem_as_words = [1000192263423663127, 10063423557586042878, 206342320401305268, 10009945728364010941, 8000774818643959860, 100021051382923523];
  ...
  let outyi_ptr = outyi.as_ptr();
  let outzi_ptr = outzi.as_ptr();
  unsafe { BLS12_G2_add(outx_ptr, outxi_ptr, outy_ptr, outyi_ptr, outz_ptr, outzi_ptr, x1_ptr, x1i_ptr, y1_ptr, y1i_ptr, z1_ptr, z1i_ptr, x2_ptr, x2i_ptr, y2_ptr, y2i_ptr, z2_ptr, z2i_ptr) };
  assert_eq!(outx, [867078973323782817, 11811876780500756034, 1745125464239106907, 3014464453997058518, 12694791767128688265, 1816671696030272421]);
  assert_eq!(outy, [264687505929143043, 14804122028137167289, 11519442418116910068, 11560058648843180624, 10080807644228027296, 158023842199296577]);
  assert_eq!(outz, [15285143568856481476, 12879132838090386368, 18186718699791570235, 1699672863184017477, 13857401575580476687, 1859991824887157809]);
  assert_eq!(outxi, [18020392373877943476, 16973873630724814902, 7619458867862165152, 12291538885140095578, 2533305606874853777, 1200203512145492183]);
  assert_eq!(outyi, [14657149261350256920, 4418264042520566151, 14628115545784928357, 5809341361878055771, 7594599970325622904, 623854357572925042]);
  assert_eq!(outzi, [212575040004254605, 8105448758167468923, 3988868365701426805, 1124269310116297788, 18215593373872965189, 417679631259833959]);
}

#[test]
fn test_BLS12_G2_add_alt() {
  let x1 : felem_as_words = [9000203289623549276, 7000342082925068282, 1000538881605221074, 10009550692327388916, 10008355200866287827, 500084205531694093];
  let y1 : felem_as_words = [11671922859260663127, 11050707557586042878, 284884720401305268, 17749945728364010941, 8613774818643959860, 145621051382923523];
  let z1 : felem_as_words = [9794203289623549276, 7309342082925068282, 1139538881605221074, 15659550692327388916, 16008355200866287827, 582484205531694093];
  let x2 : felem_as_words = [1000192263423663127, 10063423557586042878, 206342320401305268, 10009945728364010941, 8000774818643959860, 100021051382923523];
  ...
  let outya : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outza : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outxia : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outyia : felem_as_words = [0, 0, 0, 0, 0, 0];
  let outzia : felem_as_words = [0, 0, 0, 0, 0, 0];
  let x1_ptr = x1.as_ptr();
  let y1_ptr = y1.as_ptr();
  let z1_ptr = z1.as_ptr();
  let x2_ptr = x2.as_ptr();
  ...
  let outyi_ptr = outyi.as_ptr();
  let outzi_ptr = outzi.as_ptr();
  let outxia_ptr = outxia.as_ptr();
  let outyia_ptr = outyia.as_ptr();
  let outzia_ptr = outzia.as_ptr();
  unsafe { BLS12_G2_add(outx_ptr, outxi_ptr, outy_ptr, outyi_ptr, outz_ptr, outzi_ptr, x1_ptr, x1i_ptr, y1_ptr, y1i_ptr, z1_ptr, z1i_ptr, x2_ptr, x2i_ptr, y2_ptr, y2i_ptr, z2_ptr, z2i_ptr) };
  unsafe { BLS12_G2_add_alt(outxa_ptr, outxia_ptr, outya_ptr, outyia_ptr, outza_ptr, outzia_ptr, x1_ptr, x1i_ptr, y1_ptr, y1i_ptr, z1_ptr, z1i_ptr, x2_ptr, x2i_ptr, y2_ptr, y2i_ptr, z2_ptr, z2i_ptr) };
  assert_eq!(outx, outxa);
  assert_eq!(outy, outya);
  assert_eq!(outz, outza);
  assert_eq!(outxi, outxia);
  assert_eq!(outyi, outyia);
  assert_eq!(outzi, outzia);
}