...
Lemma example_0x34688_50 : ZMap.Empty (N.iter 50 (processDivstep 0x34688) state0).
Proof.
...
Lemma example_0x34689_50 : ~ZMap.Empty (N.iter 50 (processDivstep 0x34689) state0).
Proof.
intros H.
...
Lemma example_0x34688_49 : ~ZMap.Empty (N.iter 49 (processDivstep 0x34688) state0).
Proof.
intros H.
apply ZMap.is_empty_1 in H.
Time vm_compute in H.
