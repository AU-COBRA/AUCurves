...
void Fp2_add(uintptr_t outr, uintptr_t outi, uintptr_t xr, uintptr_t xi, uintptr_t yr, uintptr_t yi) {
  bls12_add(outr, yr, xr);
  bls12_add(outi, yi, xi);
  return;
}

void Fp2_sub(uintptr_t outr, uintptr_t outi, uintptr_t xr, uintptr_t xi, uintptr_t yr, uintptr_t yi) {
...
void Fp2_add_alt2(uintptr_t outr, uintptr_t outi, uintptr_t xr, uintptr_t xi, uintptr_t yr, uintptr_t yi) {
  uintptr_t xrsep;
  uintptr_t xisep;
  uintptr_t yrsep;
  uintptr_t yisep;
...
void Fp2_sub_alt2(uintptr_t outr, uintptr_t outi, uintptr_t xr, uintptr_t xi, uintptr_t yr, uintptr_t yi) {
  uintptr_t xrsep;
  uintptr_t xisep;
  uintptr_t yrsep;
  uintptr_t yisep;
...
void Fp2_mul_alt2(uintptr_t outr, uintptr_t outi, uintptr_t xr, uintptr_t xi, uintptr_t yr, uintptr_t yi) {
  uintptr_t xrsep;
  uintptr_t xisep;
  uintptr_t yrsep;
  uintptr_t yisep;
...
void BLS12_G2_add(uintptr_t outxr, uintptr_t outxi, uintptr_t outyr, uintptr_t outyi, uintptr_t outzr, uintptr_t outzi, uintptr_t X1r, uintptr_t X1i, uintptr_t Y1r, uintptr_t Y1i, uintptr_t Z1r, uintptr_t Z1i, uintptr_t X2r, uintptr_t X2i, uintptr_t Y2r, uintptr_t Y2i, uintptr_t Z2r, uintptr_t Z2i) {
  uintptr_t three_br;
  uintptr_t three_bi;
  uintptr_t t0r;
  uintptr_t t0i;
  ...
  uintptr_t t5r;
  uintptr_t t5i;
  three_br = alloca((uintptr_t)48ULL); // TODO untested
  t0r = alloca((uintptr_t)48ULL); // TODO untested
  t1r = alloca((uintptr_t)48ULL); // TODO untested
  t2r = alloca((uintptr_t)48ULL); // TODO untested
  t3r = alloca((uintptr_t)48ULL); // TODO untested
  t4r = alloca((uintptr_t)48ULL); // TODO untested
  t5r = alloca((uintptr_t)48ULL); // TODO untested
  three_bi = alloca((uintptr_t)48ULL); // TODO untested
  t0i = alloca((uintptr_t)48ULL); // TODO untested
  t1i = alloca((uintptr_t)48ULL); // TODO untested
  t2i = alloca((uintptr_t)48ULL); // TODO untested
  t3i = alloca((uintptr_t)48ULL); // TODO untested
  t4i = alloca((uintptr_t)48ULL); // TODO untested
  t5i = alloca((uintptr_t)48ULL); // TODO untested
  _br2_store(three_br, (uintptr_t)4933130441833534766ULL, sizeof(uintptr_t));
  _br2_store((three_br)+((uintptr_t)8ULL), (uintptr_t)15904462746612662304ULL, sizeof(uintptr_t));
  _br2_store((three_br)+((uintptr_t)16ULL), (uintptr_t)8034115857496836953ULL, sizeof(uintptr_t));
  _br2_store((three_br)+((uintptr_t)24ULL), (uintptr_t)12755092135412849606ULL, sizeof(uintptr_t));
  _br2_store((three_br)+((uintptr_t)32ULL), (uintptr_t)7007796720291435703ULL, sizeof(uintptr_t));
  _br2_store((three_br)+((uintptr_t)40ULL), (uintptr_t)252692002104915169ULL, sizeof(uintptr_t));
  _br2_store(three_bi, (uintptr_t)4933130441833534766ULL, sizeof(uintptr_t));
  _br2_store((three_bi)+((uintptr_t)8ULL), (uintptr_t)15904462746612662304ULL, sizeof(uintptr_t));
  _br2_store((three_bi)+((uintptr_t)16ULL), (uintptr_t)8034115857496836953ULL, sizeof(uintptr_t));
  _br2_store((three_bi)+((uintptr_t)24ULL), (uintptr_t)12755092135412849606ULL, sizeof(uintptr_t));
  _br2_store((three_bi)+((uintptr_t)32ULL), (uintptr_t)7007796720291435703ULL, sizeof(uintptr_t));
  _br2_store((three_bi)+((uintptr_t)40ULL), (uintptr_t)252692002104915169ULL, sizeof(uintptr_t));
...
void BLS12_add_alt(uintptr_t outxr, uintptr_t outxi, uintptr_t outyr, uintptr_t outyi, uintptr_t outzr, uintptr_t outzi, uintptr_t X1r, uintptr_t X1i, uintptr_t Y1r, uintptr_t Y1i, uintptr_t Z1r, uintptr_t Z1i, uintptr_t X2r, uintptr_t X2i, uintptr_t Y2r, uintptr_t Y2i, uintptr_t Z2r, uintptr_t Z2i) {
  uintptr_t X1rsep;
  uintptr_t X1isep;
  uintptr_t Y1rsep;
  uintptr_t Y1isep;
  ...
  uintptr_t Z2rsep;
  uintptr_t Z2isep;
  X1rsep = alloca((uintptr_t)48ULL); // TODO untested
  X1isep = alloca((uintptr_t)48ULL); // TODO untested
  Y1rsep = alloca((uintptr_t)48ULL); // TODO untested
  Y1isep = alloca((uintptr_t)48ULL); // TODO untested
  Z1rsep = alloca((uintptr_t)48ULL); // TODO untested
  Z1isep = alloca((uintptr_t)48ULL); // TODO untested
  X2rsep = alloca((uintptr_t)48ULL); // TODO untested
  X2isep = alloca((uintptr_t)48ULL); // TODO untested
  Y2rsep = alloca((uintptr_t)48ULL); // TODO untested
  Y2isep = alloca((uintptr_t)48ULL); // TODO untested
  Z2rsep = alloca((uintptr_t)48ULL); // TODO untested
  Z2isep = alloca((uintptr_t)48ULL); // TODO untested
...
void main() {
	...
	uint64_t oyi[6];
	uint64_t ozi[6];
	const uint64_t x1[6] = {9000203289623549276lu, 7000342082925068282lu, 1000538881605221074lu, 10009550692327388916lu, 10008355200866287827lu, 500084205531694093lu};
	const uint64_t y1[6] = {11671922859260663127lu, 11050707557586042878lu, 284884720401305268lu,
	       17749945728364010941lu, 8613774818643959860lu, 145621051382923523lu};
	const uint64_t z1[6] = {9794203289623549276lu, 7309342082925068282lu, 1139538881605221074lu,
	       15659550692327388916lu, 16008355200866287827lu, 582484205531694093lu};
	const uint64_t x2[6] = {1000192263423663127lu, 10063423557586042878lu, 206342320401305268lu,
		10009945728364010941lu, 8000774818643959860lu, 100021051382923523lu};
	const uint64_t y2[6] = {10001922859260663127lu, 10000707557586042878lu, 200084726342305268lu,
		10009945728634230941lu, 8000634238643959860lu, 100634231382923523lu};
	const uint64_t z2[6] = {10001922859260663127lu, 10000707556342342878lu, 200084726342305268lu,
		10009946342364010941lu, 8063423818643959860lu, 100021051382634233lu};
	const uint64_t z2i[6] = {9000203289623549276lu, 7000342082925068282lu, 1000538881605221074lu, 10009550692327388916lu, 10008355200866287827lu, 500084205531694093lu};
	const uint64_t y2i[6] = {11671922859260663127lu, 11050707557586042878lu, 284884720401305268lu,
	       17749945728364010941lu, 8613774818643959860lu, 145621051382923523lu};
	const uint64_t x2i[6] = {9794203289623549276lu, 7309342082925068282lu, 1139538881605221074lu,
	       15659550692327388916lu, 16008355200866287827lu, 582484205531694093lu};
	const uint64_t z1i[6] = {1000192263423663127lu, 10063423557586042878lu, 206342320401305268lu,
		10009945728364010941lu, 8000774818643959860lu, 100021051382923523lu};
	const uint64_t y1i[6] = {10001922859260663127lu, 10000707557586042878lu, 200084726342305268lu,
		10009945728634230941lu, 8000634238643959860lu, 100634231382923523lu};
	const uint64_t x1i[6] = {10001922859260663127lu, 10000707556342342878lu, 200084726342305268lu,
		10009946342364010941lu, 8063423818643959860lu, 100021051382634233lu};
	BLS12_G2_add(ox, oxi, oy, oyi, oz, ozi, x1, x1i, y1, y1i, z1, z1i, x2, x2i, y2, y2i, z2, z2i);
	printf("%lu", ox[0]);
	printf(", ");
	printf("%lu", ox[1]);
	printf(", ");
