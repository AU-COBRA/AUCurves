(* Pallas instantiation of CurveSpecsEquivalence:
   proves that the Gallina spec of Pallas point addition
...
Require Import Bedrock.Curve.Pallas_prime_certif.

Local Open Scope Z_scope.
Local Coercion Z.of_nat : nat >-> Z.

Section Pallas_Equiv.
  ...
  (* All hypotheses of CurveSpecsEquivalence.G1Equiv are satisfied.
     ...
     instantiated for Pallas. *)

  (* Convenient aliases for the instantiated equivalence results *)
  Definition pallas_gallina_fiat_equiv :=
