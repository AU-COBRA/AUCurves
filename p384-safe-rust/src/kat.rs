...
fn nontrivial_raw() -> FpRaw {
    ...
    if 6 > 1 { a[1] = 0xfedc_ba98_7654_3210; }
    if 6 > 2 { a[2] = 0x0011_2233_4455_6677; }
    if 6 > 3 { a[3] = 0x7766_5544_3322_1100; }
    if 6 > 4 { a[4] = 0xdead_beef_cafe_babe; }
    if 6 > 5 { a[5] = 0x1357_9bdf_2468_ace0; }
    // Mask top to ensure < p (most-significant limb cleared in top bits).
    a[6 - 1] &= 0x0fff_ffff_ffff_ffff;
    FpRaw(a)
}
