(* Vesta instantiation of CurveSpecsEquivalence:
   proves that the Gallina spec of Vesta point addition
...
Require Import Bedrock.Curve.Vesta_prime_certif.
...
Section Vesta_Equiv.
  ...
  Proof.
    change m with vesta_modulus.
    exact prime_vesta.
  Qed.

  (* Discriminant: 4a^3 + 27b^2 != 0 mod p
     For Vesta: 4*0^3 + 27*5^2 = 675, which is nonzero mod p. *)
