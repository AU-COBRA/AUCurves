(** * BN446 Curve Operations: point_double, store_zero, point_negate,
    ...
    Provides:
    - [bn446_point_double] : dedicated doubling (dbl-2009-l, a=0)
...
Section BN446_CurveOps.
  ...
  (** ** Point doubling: dedicated dbl-2009-l formula (a=0).
      ...
      to "bn446_square", "bn446_mul", "bn446_add", "bn446_sub" via
      [bn446_field_parameters].
      ...
      from the cmd).  With [bn446_field_parameters] as an Existing Instance,
...
Section BN446_CurveOps_Specs.
  ...
  Lemma bn446_point_double_correct :
    forall functions,
      ...
      map.get functions "curve_double" = Some (snd bn446_point_double) ->
      bn446_point_double_spec functions.
  Proof.
    intros. unfold bn446_point_double_spec.
    eapply point_double_correct; try eassumption.
    { (* loose_bounds = tight_bounds for BN446 Montgomery *)
      reflexivity. }
...
Section BN446_AllCurveOps.
  ...
  Definition bn446_curve_op_funcs : list function_t :=
    [ bn446_G1_add;            (* ladderstep: "curve_add" *)
      bn446_point_double;      (* dedicated doubling: "curve_double" *)
