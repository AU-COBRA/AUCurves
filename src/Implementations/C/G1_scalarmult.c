...
void felem_copy(uintptr_t out, uintptr_t in) {
...
void G1_add_alt(uintptr_t px1, uintptr_t px2, uintptr_t py1, uintptr_t py2, uintptr_t pz1, uintptr_t pz2, uintptr_t outx, uintptr_t outy, uintptr_t outz) {
  ...
  felem_copy(pz1a, pz1);
  felem_copy(pz2a, pz2);
  G1_add(px1, px2, py1, py2, pz1, pz2, outx, outy, outz);
  }
  }
  }
  }
...
void store_one_F(uintptr_t out) {
...
void store_zero_F(uintptr_t out) {
  _br2_store(out, (uintptr_t)0ULL, sizeof(uintptr_t));
...
void store_zero_G(uintptr_t outx, uintptr_t outy, uintptr_t outz) {
  store_zero_F(outx);
  store_one_F(outy);
  store_zero_F(outz);
  return;
...
void F_cmov(uintptr_t out0, uintptr_t in0, uintptr_t in1, uintptr_t in2) {
...
void group_cmov(uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t x1, uintptr_t y1, uintptr_t z1, uintptr_t x2, uintptr_t y2, uintptr_t z2, uintptr_t pc) {
  F_cmov(outx, _br2_load(pc, sizeof(uintptr_t)), x1, x2);
  F_cmov(outy, _br2_load(pc, sizeof(uintptr_t)), y1, y2);
  F_cmov(outz, _br2_load(pc, sizeof(uintptr_t)), z1, z2);
  return;
}
...
void scalar_mult(uintptr_t px, uintptr_t py, uintptr_t pz, uintptr_t outx, uintptr_t outy, uintptr_t outz, uintptr_t pn) {
