...
Instance spec_of_pallas_mul_bignum : spec_of "pallas_coord_mul" :=
  fun functions =>
...
Instance spec_of_pallas_add_bignum : spec_of "pallas_coord_add" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_pallas_sub_bignum : spec_of "pallas_coord_sub" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_pallas_square_bignum : spec_of "pallas_coord_square" :=
  fun functions =>
...
Instance spec_of_pallas_opp_bignum : spec_of "pallas_coord_opp" :=
  fun functions =>
    forall (wsx old_out : list word.rep)
           (px pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Lemma pallas_mul_bignum_correct :
  forall functions,
...
Lemma pallas_add_bignum_correct :
  forall functions,
...
Lemma pallas_sub_bignum_correct :
  forall functions,
...
Lemma pallas_square_bignum_correct :
  forall functions,
...
Lemma pallas_opp_bignum_correct :
  forall functions,
