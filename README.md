...
- **Operations**: G1/G2 point addition, scalar multiplication (GLV, wNAF), Miller loop, final exponentiation, multi-scalar multiplication (MSM)
- **Hash-to-curve**: G1 and G2 (SWU + isogeny), SHAKE-256 via verified Keccak
- **Safe-Rust extraction**: bedrock2 → verified Rust pipeline (BLS12-381, BN254, BN256, BN446)
- **Jasmin backend**: bedrock2 → Jasmin extraction for Curve25519 / XEdDSA
