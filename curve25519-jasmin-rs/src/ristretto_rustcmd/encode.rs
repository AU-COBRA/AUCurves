...
pub fn ristretto_encode(xyzt_var: &mut [u8; 200], out_var: &mut [u8; 32]) {
    ...
    let mut z_var: [u8; 40] = [0; 40];
    let mut ta_var: [u8; 40] = [0; 40];
    let mut tb_var: [u8; 40] = [0; 40];
    let mut one_var: [u8; 40] = [0; 40];
    let mut p_var: [u8; 40] = [0; 40];
    let mut sqrtm1_var: [u8; 40] = [0; 40];
    let mut invad_var: [u8; 40] = [0; 40];
    let mut zinv_var: [u8; 40] = [0; 40];
    let mut tatb_var: [u8; 40] = [0; 40];
    let mut t_var: [u8; 40] = [0; 40];
    let mut zpy_var: [u8; 40] = [0; 40];
    let mut zmy_var: [u8; 40] = [0; 40];
    let mut u1_var: [u8; 40] = [0; 40];
    let mut u2_var: [u8; 40] = [0; 40];
    let mut u2sq_var: [u8; 40] = [0; 40];
    let mut den_var: [u8; 40] = [0; 40];
    let mut ws_var: [u8; 1] = [0; 1];
    let mut invsqrt_var: [u8; 40] = [0; 40];
    let mut D1_var: [u8; 40] = [0; 40];
    let mut D2_var: [u8; 40] = [0; 40];
    let mut D1D2_var: [u8; 40] = [0; 40];
    let mut Zinv_var: [u8; 40] = [0; 40];
    let mut ix_var: [u8; 40] = [0; 40];
    let mut iy_var: [u8; 40] = [0; 40];
    let mut eden_var: [u8; 40] = [0; 40];
    let mut tZinv_var: [u8; 40] = [0; 40];
    let mut xp_var: [u8; 40] = [0; 40];
    let mut yp_var: [u8; 40] = [0; 40];
    let mut deninv_var: [u8; 40] = [0; 40];
    let mut xzinv_var: [u8; 40] = [0; 40];
    let mut ypneg_var: [u8; 40] = [0; 40];
    let mut ypp_var: [u8; 40] = [0; 40];
    let mut zmypp_var: [u8; 40] = [0; 40];
    let mut sraw_var: [u8; 40] = [0; 40];
    let mut sneg_var: [u8; 40] = [0; 40];
    ...
    sqrtm1_var.copy_from_slice(&[176u8, 160u8, 14u8, 74u8, 39u8, 27u8, 238u8, 196u8, 120u8, 228u8, 47u8, 173u8, 6u8, 24u8, 67u8, 47u8, 167u8, 215u8, 251u8, 61u8, 153u8, 0u8, 77u8, 43u8, 11u8, 223u8, 193u8, 79u8, 128u8, 36u8, 131u8, 43u8, 0u8, 0u8, 0u8, 0u8, 0u8, 0u8, 0u8, 0u8]);
    invad_var.copy_from_slice(&[234u8, 64u8, 93u8, 128u8, 170u8, 253u8, 200u8, 153u8, 190u8, 114u8, 65u8, 90u8, 23u8, 22u8, 47u8, 157u8, 64u8, 216u8, 1u8, 254u8, 145u8, 123u8, 194u8, 22u8, 162u8, 252u8, 175u8, 207u8, 5u8, 137u8, 108u8, 120u8, 0u8, 0u8, 0u8, 0u8, 0u8, 0u8, 0u8, 0u8]);
