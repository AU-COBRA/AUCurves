...
Definition ristretto_encode_rs : rust_cmd_ed :=
  ...
  REdSeq (REdCallN "unpack_xyzt5"
            [LE_TBytes_r v_re_x  40; LE_TBytes_r v_re_y  40;
             LE_TBytes_r v_re_z  40; LE_TBytes_r v_re_ta 40;
             LE_TBytes_r v_re_tb 40]
            [LE_TBytes_r v_re_xyzt 32])
  (* constants *)
  (REdSeq (REdSetBytes (LE_TBytes_r v_re_one    40) const_one_zs)
  (REdSeq (REdSetBytes (LE_TBytes_r v_re_p      40) const_p_zs)
  (REdSeq (REdSetBytes (LE_TBytes_r v_re_sqrtm1 40) const_sqrt_m1_zs)
  (REdSeq (REdSetBytes (LE_TBytes_r v_re_invad  40) const_invsqrt_amd_zs)
  (* t = extended_T ta tb z = ta*tb*z^(p-2) *)
  (REdSeq (REdCall "fe25519_inv" (LE_TBytes_r v_re_zinv 40)
                                  [LE_TBytes_r v_re_z 40])
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_tatb 40)
                                  [LE_TBytes_r v_re_ta 40; LE_TBytes_r v_re_tb 40])
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_t 40)
                                  [LE_TBytes_r v_re_tatb 40; LE_TBytes_r v_re_zinv 40])
  (* u1 = (z+y)*(z-y) *)
  (REdSeq (REdCall "fe25519_add" (LE_TBytes_r v_re_zpy 40)
                                  [LE_TBytes_r v_re_z 40; LE_TBytes_r v_re_y 40])
  (REdSeq (REdCall "fe25519_sub" (LE_TBytes_r v_re_zmy 40)
                                  [LE_TBytes_r v_re_z 40; LE_TBytes_r v_re_y 40])
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_u1 40)
                                  [LE_TBytes_r v_re_zpy 40; LE_TBytes_r v_re_zmy 40])
  (* u2 = x*y *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_u2 40)
                                  [LE_TBytes_r v_re_x 40; LE_TBytes_r v_re_y 40])
  (* u2_sq = u2*u2 *)
  (REdSeq (REdCall "fe25519_sq" (LE_TBytes_r v_re_u2sq 40)
                                 [LE_TBytes_r v_re_u2 40])
  (* den = u1*u2_sq *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_den 40)
                                  [LE_TBytes_r v_re_u1 40; LE_TBytes_r v_re_u2sq 40])
  (* (ws, invsqrt) = sqrt_ratio_m1(one, den) *)
  (REdSeq (REdCallN "ristretto_sqrt_ratio_m1"
            [LE_TBytes_r v_re_ws 1; LE_TBytes_r v_re_invsqrt 40]
            [LE_TBytes_r v_re_one 40; LE_TBytes_r v_re_den 40])
  (* D1 = invsqrt*u1 *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_D1 40)
                                  [LE_TBytes_r v_re_invsqrt 40; LE_TBytes_r v_re_u1 40])
  (* D2 = invsqrt*u2 *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_D2 40)
                                  [LE_TBytes_r v_re_invsqrt 40; LE_TBytes_r v_re_u2 40])
  (* D1D2 = D1*D2 *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_D1D2 40)
                                  [LE_TBytes_r v_re_D1 40; LE_TBytes_r v_re_D2 40])
  (* Zinv = D1D2*t  (= D1*D2*t) *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_Zinv 40)
                                  [LE_TBytes_r v_re_D1D2 40; LE_TBytes_r v_re_t 40])
  (* ix = x*sqrtm1 *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_ix 40)
                                  [LE_TBytes_r v_re_x 40; LE_TBytes_r v_re_sqrtm1 40])
  (* iy = y*sqrtm1 *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_iy 40)
                                  [LE_TBytes_r v_re_y 40; LE_TBytes_r v_re_sqrtm1 40])
  (* eden = D1*invad *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_eden 40)
                                  [LE_TBytes_r v_re_D1 40; LE_TBytes_r v_re_invad 40])
  (* tZinv = t*Zinv *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_tZinv 40)
                                  [LE_TBytes_r v_re_t 40; LE_TBytes_r v_re_Zinv 40])
  (* rotate = bit0(tZinv) *)
  (REdSeq (REdByteLoad v_re_rotbit (LE_TBytes_r v_re_tZinv 40) (SLit 0))
  (* x' = rotate ? iy : x *)
  (REdSeq (REdSelect (SAnd (SVar v_re_rotbit) (SLit 1))
             (LE_TBytes_r v_re_iy 40) (LE_TBytes_r v_re_x 40) (LE_TBytes_r v_re_xp 40))
  (* y' = rotate ? ix : y *)
  (REdSeq (REdSelect (SAnd (SVar v_re_rotbit) (SLit 1))
             (LE_TBytes_r v_re_ix 40) (LE_TBytes_r v_re_y 40) (LE_TBytes_r v_re_yp 40))
  (* den_inv = rotate ? eden : D2 *)
  (REdSeq (REdSelect (SAnd (SVar v_re_rotbit) (SLit 1))
             (LE_TBytes_r v_re_eden 40) (LE_TBytes_r v_re_D2 40) (LE_TBytes_r v_re_deninv 40))
  (* x_z_inv = x'*Zinv *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_xzinv 40)
                                  [LE_TBytes_r v_re_xp 40; LE_TBytes_r v_re_Zinv 40])
  (* yp_neg = p - y' *)
  (REdSeq (REdCall "fe25519_sub" (LE_TBytes_r v_re_ypneg 40)
                                  [LE_TBytes_r v_re_p 40; LE_TBytes_r v_re_yp 40])
  (* xzbit = bit0(x_z_inv) *)
  (REdSeq (REdByteLoad v_re_xzbit (LE_TBytes_r v_re_xzinv 40) (SLit 0))
  (* y'' = is_negative(x_z_inv) ? -y' : y' *)
  (REdSeq (REdSelect (SAnd (SVar v_re_xzbit) (SLit 1))
             (LE_TBytes_r v_re_ypneg 40) (LE_TBytes_r v_re_yp 40) (LE_TBytes_r v_re_ypp 40))
  (* z - y'' *)
  (REdSeq (REdCall "fe25519_sub" (LE_TBytes_r v_re_zmypp 40)
                                  [LE_TBytes_r v_re_z 40; LE_TBytes_r v_re_ypp 40])
  (* s_raw = den_inv*(z - y'') *)
  (REdSeq (REdCall "fe25519_mul" (LE_TBytes_r v_re_sraw 40)
                                  [LE_TBytes_r v_re_deninv 40; LE_TBytes_r v_re_zmypp 40])
  (* s_neg = p - s_raw *)
  (REdSeq (REdCall "fe25519_sub" (LE_TBytes_r v_re_sneg 40)
                                  [LE_TBytes_r v_re_p 40; LE_TBytes_r v_re_sraw 40])
  (* sbit = bit0(s_raw) *)
  (REdSeq (REdByteLoad v_re_sbit (LE_TBytes_r v_re_sraw 40) (SLit 0))
  (* s = is_negative(s_raw) ? -s_raw : s_raw *)
  (REdSeq (REdSelect (SAnd (SVar v_re_sbit) (SLit 1))
             (LE_TBytes_r v_re_sneg 40) (LE_TBytes_r v_re_sraw 40) (LE_TBytes_r v_re_s 40))
  (* out = pack_canonical(s) *)
  (REdCall "ristretto_pack_canonical_felem" (LE_TBytes_r v_re_out 32)
           [LE_TBytes_r v_re_s 40])
  )))))))))))))))))))))))))))))))))
  )))))))))))))))))))))))))))))))))))))))).
