...
Instance spec_of_bn256_mul_bignum : spec_of "bn256_coord_mul" :=
  fun functions =>
...
Instance spec_of_bn256_add_bignum : spec_of "bn256_coord_add" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_bn256_sub_bignum : spec_of "bn256_coord_sub" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_bn256_square_bignum : spec_of "bn256_coord_square" :=
  fun functions =>
...
Instance spec_of_bn256_opp_bignum : spec_of "bn256_coord_opp" :=
  fun functions =>
    forall (wsx old_out : list word.rep)
           (px pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Lemma bn256_mul_bignum_correct :
  forall functions,
...
Lemma bn256_add_bignum_correct :
  forall functions,
...
Lemma bn256_sub_bignum_correct :
  forall functions,
...
Lemma bn256_square_bignum_correct :
  forall functions,
...
Lemma bn256_opp_bignum_correct :
  forall functions,
