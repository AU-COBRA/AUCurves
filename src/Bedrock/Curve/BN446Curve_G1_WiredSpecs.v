...
Instance spec_of_bn446_mul_bignum : spec_of "bn446_coord_mul" :=
  fun functions =>
...
Instance spec_of_bn446_add_bignum : spec_of "bn446_coord_add" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_bn446_sub_bignum : spec_of "bn446_coord_sub" :=
  fun functions =>
    forall (wsx wsy old_out : list word.rep)
           (px py pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Instance spec_of_bn446_square_bignum : spec_of "bn446_coord_square" :=
  fun functions =>
...
Instance spec_of_bn446_opp_bignum : spec_of "bn446_coord_opp" :=
  fun functions =>
    forall (wsx old_out : list word.rep)
           (px pout : word.rep)
           (tr : trace) (mem0 : @map.rep _ _ BasicC64Semantics.mem)
...
Lemma bn446_mul_bignum_correct :
  forall functions,
...
Proof.
  ...
  change 7%nat with felem_size_in_words in Hlenout, Hlenx, Hleny, Hsepx, Hsepy, Hsepout.
...
Lemma bn446_add_bignum_correct :
  forall functions,
...
Lemma bn446_sub_bignum_correct :
  forall functions,
...
Lemma bn446_square_bignum_correct :
  forall functions,
...
Proof.
  ...
  pose proof (Bignum_length _ _ _ _ _ Hsepx) as Hlenx.
  change 7%nat with felem_size_in_words in Hlenout, Hlenx, Hsepx, Hsepout.
  set (fx := exist _ wsx Hlenx : felem).
  set (fout := exist _ old_out Hlenout : felem).
  seprewrite_in (Bignum_to_FElem px wsx Hlenx) Hsepx.
  seprewrite_in (Bignum_to_FElem pout old_out Hlenout) Hsepout.
...
Lemma bn446_opp_bignum_correct :
  forall functions,
